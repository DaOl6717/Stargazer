...
from scoring import image_score, neutralise_colour

def optimise_parameters(image, n_trials=50):
    def objective(trial):
        params = {
            "stretch": trial.suggest_float("stretch", 1.0, 2.5),
            ...
            "exposure": trial.suggest_float("exposure", 1.2, 2.5),
        ...
        processed = neutralise_colour(processed)
